  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        className="space-y-2"
      >
        <h3 className="text-lg font-semibold text-primary">No Chats Yet</h3>
        <p className="text-sm text-secondary max-w-xs">
          Start a new conversation to begin chatting with your agent.
        </p>
      </motion.div>
      ...
      {onCreateSession && (
        ...
        >
          <Button onClick={onCreateSession} variant="primary" size="md">
            <Plus size={16} />
            New Chat
          </Button>
        </motion.div>
